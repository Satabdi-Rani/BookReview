...
const Banner = () => {
    return (
        <div className='container mx-auto'>
            <div className="background w-full h-[400px] sm:h-[600px] bg-no-repeat bg-contain sm:bg-cover  border rounded-3xl text-white flex flex-col sm:justify-center items-end pr-10">
